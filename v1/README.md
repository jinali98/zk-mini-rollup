...
│   ├── build.sh             # Build script (compile + generate verifier)
│   └── src/
│       └── main.nr          # ZK circuit (Noir)
├── contracts/
│   └── Verifier.sol         # Auto-generated Solidity verifier contract
├── operators/               # Placeholder for future operator code
└── scripts/
...
### 4. Build circuit and generate verifier
...
- Generate the Solidity verifier contract (`../contracts/Verifier.sol`)
...
The `contracts/Verifier.sol` file is auto-generated by the `build.sh` script. This Solidity contract can be deployed to Ethereum to verify proofs on-chain. The verifier uses the UltraHonk proof system and is generated from your circuit's verification key.

**Note**: This file is auto-generated—do not edit it manually. Regenerate it by running `./build.sh` after making changes to your circuit.
